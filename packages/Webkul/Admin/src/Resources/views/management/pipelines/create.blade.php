<x-admin::layouts>
    <x-slot:title>
        @lang('admin::app.management.pipelines.create.title')
    </x-slot>

    {!! view_render_event('admin.management.pipelines.create.form.before') !!}

    <x-admin::form
        :action="route('admin.management.pipelines.store')"
        method="POST"
    >
        <div class="flex flex-col gap-2 rounded-lg border border-gray-300 bg-white text-sm dark:border-gray-800 dark:bg-gray-900 dark:text-gray-300">
            <div class="flex items-center justify-between px-4 py-2">
                <div class="flex flex-col gap-2">
                    {!! view_render_event('admin.management.pipelines.create.breadcrumbs.before') !!}

                    <x-admin::breadcrumbs name="management.pipelines.create" />

                    {!! view_render_event('admin.management.pipelines.create.breadcrumbs.after') !!}
                ...
                <div class="flex items-center gap-x-2.5">
                    <div class="flex items-center gap-x-2.5">
                        {!! view_render_event('admin.management.pipelines.create.save_button.before') !!}

                        <button
                            type="submit"
                            class="primary-button"
                        >
                            @lang('admin::app.management.pipelines.create.save-btn')
                        </button>

                        {!! view_render_event('admin.management.pipelines.create.save_button.after') !!}
                    </div>
                </div>
            </div>

            <div class="flex gap-4 border-t border-gray-300 px-4 py-2 align-top dark:border-gray-800 max-sm:flex-wrap">
                {!! view_render_event('admin.management.pipelines.create.form.name.before') !!}

                <x-admin::form.control-group>
                    <x-admin::form.control-group.label class="required">
                        @lang('admin::app.management.pipelines.create.name')
                    ...
                    <x-admin::form.control-group.control
                        ...
                        id="name"
                        rules="required"
                        :label="trans('admin::app.management.pipelines.create.name')"
                        :placeholder="trans('admin::app.management.pipelines.create.name')"
                        value="{{ old('name') }}"
                    />
                ...
                {!! view_render_event('admin.management.pipelines.create.form.name.after') !!}

                {!! view_render_event('admin.management.pipelines.create.form.rotten_days.before') !!}

                <x-admin::form.control-group>
                    <x-admin::form.control-group.label class="required">
                        @lang('admin::app.management.pipelines.create.rotten-days')
                    </x-admin::form.control-group.label>
                    ...
                    <x-admin::form.control-group.control
                        ...
                        :label="trans('admin::app.management.pipelines.create.rotten-days')"
                        :placeholder="trans('admin::app.management.pipelines.create.rotten-days')"
                ...
                {!! view_render_event('admin.management.pipelines.create.form.rotten_days.after') !!}

                {!! view_render_event('admin.management.pipelines.create.form.is_default.before') !!}

                <x-admin::form.control-group class="!mb-0 flex items-center gap-4">
                    <x-admin::form.control-group.label class="!mb-0">
                        @lang('admin::app.management.pipelines.create.mark-as-default')
                    </x-admin::form.control-group.label>
                    ...
                    <x-admin::form.control-group.control
                        ...
                        value="1"
                        for="is_default"
                        :label="trans('admin::app.management.pipelines.create.mark-as-default')"
                    />

                    <x-admin::form.control-group.error control-name="is_default" />
                </x-admin::form.control-group>

                {!! view_render_event('admin.management.pipelines.create.form.is_default.after') !!}
            </div>
        </div>

        <div class="flex gap-2.5 overflow-auto py-3.5 max-xl:flex-wrap">
            {!! view_render_event('admin.management.pipelines.create.form.stages.before') !!}

            <v-stages-management-component>
                <x-admin::shimmer.pipelines.kanban />
            </v-stages-management-component>

            {!! view_render_event('admin.management.pipelines.create.form.stages.after') !!}
        </div>
    </x-admin::form>

    {!! view_render_event('admin.management.pipelines.create.form.after') !!}
                            ...
                            <div class="flex min-w-[275px] max-w-[275px] flex-col justify-between rounded-lg border border-gray-300 bg-white dark:border-gray-800 dark:bg-gray-900">
                                <div class="flex flex-col gap-6 px-4 py-3">
                                    ...
                                    <div>
                                        ...
                                        {!! view_render_event('admin.management.pipelines.create.form.stages.name.before') !!}
                                        ...
                                        {!! view_render_event('admin.management.pipelines.create.form.stages.probability.before') !!}

                                        <x-admin::form.control-group>
                                            <x-admin::form.control-group.label class="required">
                                                @lang('admin::app.management.pipelines.create.probability')
                                            </x-admin::form.control-group.label>
                                        ...
                                        {!! view_render_event('admin.management.pipelines.create.form.stages.probability.after') !!}
                                    </div>
                                </div>
                                
                                {!! view_render_event('admin.management.pipelines.create.form.stages.delete_button.before') !!}
                                ...
                                >
                                    ...
                                    @lang('admin::app.management.pipelines.create.delete-stage')
                                </div>

                                {!! view_render_event('admin.management.pipelines.create.form.stages.delete_button.after') !!}
                            </div>
                        </div>
                        ...
                        <div class="grid justify-center justify-items-center gap-3.5 text-center">
                            <div class="flex flex-col items-center gap-2">
                                <p class="text-xl font-semibold dark:text-gray-300">
                                    @lang('admin::app.management.pipelines.create.add-new-stages')
                                </p>

                                <p class="text-gray-400">
                                    @lang('admin::app.management.pipelines.create.add-stage-info')
                                </p>
                            </div>

                            {!! view_render_event('admin.management.pipelines.create.form.stages.create_button.before') !!}
                            ...
                            <button
                                ...
                                type="button"
                            >
                                @lang('admin::app.management.pipelines.create.stage-btn')
                            </button>

                            {!! view_render_event('admin.management.pipelines.create.form.stages.create_button.after') !!}
                        </div>
                    </div>
                </div>
            </div>
                ...
                data() {
                    return {
                        stages: [{
                            'id': 'stage_1',
                            'code': 'new', 
                            'name': "@lang('admin::app.management.pipelines.create.new-stage')",
                            'probability': 100
                        }, {
                            'id': 'stage_2',
                            'code': '',
                            ...
                            'id': 'stage_99',
                            'code': 'won',
                            'name': "@lang('admin::app.management.pipelines.create.won-stage')",
                            'probability': 100
                        }, {
                            'id': 'stage_100',
                            'code': 'lost',
                            'name': "@lang('admin::app.management.pipelines.create.lost-stage')",
                            'probability': 0
                        }],
                    ...
                    removeStage(stage) {
                        this.$emitter.emit('open-confirm-modal', {
                            agree: () => {
                                ...
                                this.$emitter.emit('add-flash', { type: 'success', message: "@lang('admin::app.management.pipelines.create.stage-delete-success')" });
                            }
                        });
                    },
