...
export const propertySchema = z.object({
  ...
  price: z.union([z.number(), z.string().transform(v => Number(v) || 0)]).optional().nullable(),
  currency: z.string().optional().nullable(),
  areaTotal: z.union([z.number(), z.string().transform(v => Number(v) || 0)]).optional().nullable(),
  areaBuilt: z.union([z.number(), z.string().transform(v => Number(v) || 0)]).optional().nullable(),
  bedrooms: z.union([z.number(), z.string().transform(v => Number(v) || 0)]).optional().nullable(),
  bathrooms: z.union([z.number(), z.string().transform(v => Number(v) || 0)]).optional().nullable(),
  parkingSpots: z.union([z.number(), z.string().transform(v => Number(v) || 0)]).optional().nullable(),
  ...
  commissionPct: z.union([z.number(), z.string().transform(v => Number(v) || 0)]).optional().nullable(),
  featured: z.boolean().optional().nullable(),
  projectName: z.string().optional().or(z.literal('')).nullable(),
