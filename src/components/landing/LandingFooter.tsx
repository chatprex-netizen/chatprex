        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="space-y-3 md:col-span-2">
            <div className="flex items-center gap-2 text-white font-manrope font-extrabold text-base">
              <div className="w-7 h-7 rounded-lg bg-[#1154FF] text-white flex items-center justify-center shadow-md shadow-blue-500/20">
              ...
              <div className="flex items-center gap-2">
                {socialLinks.map((social) => (
                  <a
                    ...
                    className={`w-8 h-8 rounded-lg bg-white/5 dark:bg-white/[0.04] border border-white/10 dark:border-white/[0.08] flex items-center justify-center text-slate-300 transition-all ${social.color}`}
                  >
                    {social.icon}
                  </a>
                ))}
