...
export const LandingFooter: React.FC = () => {
  ...
  const socialLinks = [
    {
      name: 'WhatsApp',
      url: portalConfig?.socialLinks?.whatsapp || 'https://wa.me/51957100984?text=Hola%2C%20deseo%20informaci%C3%B3n%20sobre%20proyectos%20y%20propiedades%20en%20CasaYa',
      icon: (
    ...
    {
      name: 'Facebook',
      url: portalConfig?.socialLinks?.facebook || 'https://facebook.com',
      icon: (
        <svg className="w-4 h-4 fill-current" viewBox="0 0 24 24">
    ...
    {
      name: 'Instagram',
      url: portalConfig?.socialLinks?.instagram || 'https://instagram.com',
      icon: (
        <svg className="w-4 h-4 fill-current" viewBox="0 0 24 24">
    ...
    {
      name: 'TikTok',
      url: portalConfig?.socialLinks?.tiktok || 'https://tiktok.com',
      icon: (
        <svg className="w-4 h-4 fill-current" viewBox="0 0 24 24">
    ...
    {
      name: 'YouTube',
      url: portalConfig?.socialLinks?.youtube || 'https://youtube.com',
      icon: (
        <svg className="w-4 h-4 fill-current" viewBox="0 0 24 24">
      ...
      <div className="max-w-6xl mx-auto px-4 space-y-8">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center md:text-left">
              ...
              <div className="flex items-center justify-center md:justify-start gap-2">
                {socialLinks.map((social) => (
                  <a
                    ...
                    className="w-9 h-9 rounded-xl bg-[#1154FF]/10 dark:bg-[#38BDF8]/10 border border-[#1154FF]/25 dark:border-[#38BDF8]/25 text-[#1154FF] dark:text-[#38BDF8] hover:bg-[#1154FF] hover:text-white dark:hover:bg-[#38BDF8] dark:hover:text-black flex items-center justify-center transition-all transform hover:scale-105 shadow-sm cursor-pointer"
                  >
                    {social.icon}
                  </a>
                ))}
          ...
          <div className="col-span-1 space-y-2.5 flex flex-col items-center md:items-start text-center md:text-left">
            ...
            <ul className="space-y-1.5 text-xs font-normal flex flex-col items-center md:items-start">
              <li>
