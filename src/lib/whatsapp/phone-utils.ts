/**
 * Phone number utilities for Meta WhatsApp Cloud API.
 *
 * Extracted from github.com/ArnasDon/wacrm — standalone, zero dependencies.
 */
 ...
 * meant to be dropped in international format.
 *
