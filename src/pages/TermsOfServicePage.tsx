      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 py-10 sm:py-14 space-y-10">
        ...
        <div className="space-y-3 border-b border-slate-800 pb-8">
          ...
          <p className="text-sm text-slate-400 leading-relaxed">
            Última actualización: <strong className="text-slate-200">{lastUpdated}</strong>. Te invitamos a leer con atención estos Términos y Condiciones que regulan el acceso, navegación y uso de la plataforma tecnológica <strong>Prexup CRM</strong> y sus módulos de integración omnicanal.
          </p>
        </div>
        ...
        <section className="space-y-3">
          <h2 className="text-lg sm:text-xl font-bold text-white flex items-center gap-2">
            ...
            <span>Descripción de la Plataforma y Servicios</span>
          </h2>
          <div className="p-4 rounded-xl bg-slate-900/60 border border-slate-800 text-xs sm:text-sm text-slate-300 space-y-2 leading-relaxed">
            <p>
              <strong>Prexup CRM</strong> provee un software de gestión de relaciones comerciales (CRM) diseñado para el sector inmobiliario que incluye:
            </p>
        ...
        <section className="space-y-3">
          ...
          <div className="p-4 rounded-xl bg-slate-900/60 border border-slate-800 text-xs sm:text-sm text-slate-300 space-y-2 leading-relaxed">
            <p>
              El usuario es el único responsable de la confidencialidad de sus credenciales de acceso (usuario y contraseña) y de las claves de API (Meta Access Tokens, OpenAI/DeepSeek API Keys, etc.) ingresadas en la plataforma. Prexup CRM no se hace responsable por accesos no autorizados derivados del descuido o revelación voluntaria de credenciales por parte del usuario.
            </p>
          </div>
        </section>
        ...
        <section className="space-y-3">
          <h2 className="text-lg sm:text-xl font-bold text-white flex items-center gap-2">
            ...
            <span>Disponibilidad del Servicio y Limitación de Responsabilidad</span>
          </h2>
          <div className="p-4 rounded-xl bg-slate-900/60 border border-slate-800 text-xs sm:text-sm text-slate-300 space-y-2 leading-relaxed">
            <p>
              Nos esforzamos por mantener la plataforma operativa de forma ininterrumpida (99.9% uptime). Sin embargo, el servicio se provee &quot;tal cual&quot; y &quot;según disponibilidad&quot;. Prexup CRM no asume responsabilidad por:
            </p>
            <ul className="list-disc pl-5 space-y-1 text-xs text-slate-400">
              <li>Interrupciones temporales o caídas de servicio originadas por proveedores externos (como Meta Platforms, WhatsApp, OpenAI, servidores en la nube o fallos de telecomunicaciones).</li>
              <li>Bloqueos o sanciones aplicadas por Meta a números de teléfono por infracción de las políticas de uso de WhatsApp.</li>
              <li>Pérdidas comerciales indirectas resultantes del uso o imposibilidad de uso del software.</li>
            </ul>
          </div>
        </section>

        {/* Section 7: Modificaciones y Cancelación */}
        <section className="space-y-3">
          <h2 className="text-lg sm:text-xl font-bold text-white flex items-center gap-2">
            ...
            <span>Modificaciones de los Términos y Terminación</span>
          </h2>
          <div className="p-4 rounded-xl bg-slate-900/60 border border-slate-800 text-xs sm:text-sm text-slate-300 space-y-2 leading-relaxed">
            <p>
              Nos reservamos el derecho de modificar estos Términos periódicamente para reflejar mejoras en el servicio o cambios regulatorios. Las actualizaciones entrarán en vigencia tras su publicación en esta misma URL. Nos reservamos el derecho de suspender temporal o definitivamente cuentas que incurran en actividades ilícitas o violaciones graves a estos términos.
            </p>
          </div>
        </section>
        ...
        <section className="p-5 rounded-2xl bg-gradient-to-r from-blue-950/40 via-slate-900 to-indigo-950/40 border border-blue-900/40 space-y-3">
          ...
          <div className="flex flex-wrap items-center gap-4 text-xs font-semibold pt-1">
            <a href="mailto:legal@prexup.com" className="flex items-center gap-1.5 text-blue-400 hover:underline">
              <Mail className="w-3.5 h-3.5" />
              <span>legal@prexup.com</span>
            </a>
